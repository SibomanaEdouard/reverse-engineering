...
key_part_static1_trial = "picoCTF{1n_7h3_|<3y_of_the_"
...
def check_key(key, username_trial):
    ...
    if len(key) != len(key_full_template_trial):
        ...
        if key[i:] != hashlib.sha256(username_trial.encode()).hexdigest()[1:9]:
            return False
